...
import { Box, Typography, Button, Alert, Card, CardContent, Fade } from '@mui/material';
            ...
            >
              <CardContent sx={{ p: 4 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                  The Survey Statistics dashboard encountered an unexpected error. This might be a
                  temporary issue.
                </Typography>
