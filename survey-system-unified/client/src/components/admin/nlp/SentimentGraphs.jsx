      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          >
            ...
            <Scatter
              name="Accommodation"
              data={data.filter((d) => d.category === 'Accommodation')}
              fill="#00C49F"
            />
            <Scatter
              name="Transportation"
              data={data.filter((d) => d.category === 'Transportation')}
              fill="#FF8042"
            />
            <Scatter
              name="Services"
              data={data.filter((d) => d.category === 'Services')}
              fill="#0088FE"
            />
            <Scatter
              name="Activity/Events"
              data={data.filter((d) => d.category === 'Activity/Events')}
              fill="#FFBB28"
            />
          </ScatterChart>
