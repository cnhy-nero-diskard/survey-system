...
Ensure secret configuration is centrally classified and validated, no functioning secret value is committed, weak or duplicated secrets are rejected at startup, and secret generation/rotation is documented.
