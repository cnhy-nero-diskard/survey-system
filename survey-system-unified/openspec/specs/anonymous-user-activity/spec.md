...
Ensure anonymous survey users' activity is tracked by a last-activity timestamp rather than per-request timers, so active state is derived accurately and continuous browsing is never incorrectly marked inactive.
